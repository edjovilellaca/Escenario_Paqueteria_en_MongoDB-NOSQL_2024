...
db.getCollection('oficina').insertMany([
    ...
    //Oficina 2
    {ID: "OF002", nombre: "Oficina Monterrey",
    direccion: {
        calle: "Calle Morelos",
        numero: 450,
        ciudad: "Monterrey",
    ...
    //Oficina 3
    {ID: "OF003", nombre: "Oficina Guadalajara",
    direccion: {
    ...
    //Oficina 4
    {ID: "OF004", nombre: "Oficina Mérida",
    direccion: {
...
const q8 = db.getCollection('envio').aggregate([
